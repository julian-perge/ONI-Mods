...
namespace MoreRockCrusherOptions
{
		...
		public class AbyssaliteIronOre
		{
				public static void Postfix(ref GameObject go)
				{
						...
						ComplexRecipe.RecipeElement[] results3 = new ComplexRecipe.RecipeElement[2]
						{
						...
						new ComplexRecipe(
								ComplexRecipeManager.MakeRecipeID(
										"RockCrusher"
										, (IList<ComplexRecipe.RecipeElement>)ingredients3
										, (IList<ComplexRecipe.RecipeElement>)results3)
